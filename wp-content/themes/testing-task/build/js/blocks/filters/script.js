...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function _loadFilters() {
    _loadFilters = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var _data$brands, _data$categories, response, data, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            _context.n = 1;
            return fetch('/wp-json/catalog/v1/cars');
          case 1:
            response = _context.v;
            if (response.ok) {
              _context.n = 2;
          ...
          case 3:
            data = _context.v;
            clearOptionsExceptFirst(brandSelect);
            clearOptionsExceptFirst(categorySelect);
            (_data$brands = data.brands) === null || _data$brands === void 0 || _data$brands.forEach(function (brand) {
              brandSelect.appendChild(createOption(brand.value, brand.label));
            });
            (_data$categories = data.categories) === null || _data$categories === void 0 || _data$categories.forEach(function (category) {
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      console.log('Обраний бренд:', selectedBrand);
